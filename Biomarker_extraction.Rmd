---
title: "Biomarker_extraction"
output: html_document
date: "2025-08-03"
---
```{r setup, include=FALSE}
knitr::opts_chunk$set(fig.show = 'hide')
setwd("C:/Users/harsh/OneDrive - University of California, San Diego Health/Projects/Foods/500_foods/")
library(tidyverse)
library(mixOmics)
library(stringr)
library(ggplot2)
...
library_matches <- read_tsv("merged_results_with_gnps.tsv")
metadata <- read_csv("Metadata_500food.csv") %>% arrange(filename)
...
m_filter <- metadata %>%
  ...
  filter(!str_detect(filename, "P1_F10_G75112"))
