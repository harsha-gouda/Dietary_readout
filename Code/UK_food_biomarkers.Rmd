...
setwd("C:/Users/harsh/OneDrive - University of California, San Diego Health/Projects/Urine_samples/UK_foods/")
library(tidyverse)
library(mixOmics)
library(stringr)
library(ggplot2)
...
```{r data_import}
#read_file
feature_table <- read_csv("UK_foods_iimn_gnps_quant.csv")
library_matches <- read_csv("UK_foods_annotations.csv")
metadata <- read_csv("Food_classes.csv") %>% arrange(filename)
